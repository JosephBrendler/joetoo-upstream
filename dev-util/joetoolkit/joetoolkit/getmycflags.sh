...
source /usr/sbin/setTIMEFORMAT.hdr
source /usr/sbin/setnodistpath
...
# use setTIMEFORMAT.hdr to specify long format time measurement
setTIMEFORMAT -l
...
time gcc -fverbose-asm -march=native native.cc -S
...
time gcc -fverbose-asm "${options}" march.cc -S
